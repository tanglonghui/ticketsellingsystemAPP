...
public class PRegister extends XPresent<RegisterActivity> {
    public void doRegister(String account, String password, String name, String sex, String phone) {
        ...
        map.put("sex", sex);
        map.put("phone", phone);
        Api.getRegisterService().register(map)
